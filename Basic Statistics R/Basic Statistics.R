...
# Read data into R
education <- read_csv("C:/Datasets_BA/Malaysia/Data Science/New-360Digitmg/Module 02_Exploratory Data Analytics (EDA) - Descriptive Analytics/Dataset/education.csv")
