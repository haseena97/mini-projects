...
data = pd.read_csv("C:\\Users\Acer\Downloads\Decision Tree\credit\credit.csv")

data.describe() # works only for numeric data
data.info()
...
predictors = colnames[:15] # kena simpan count utk semua x columns
target = colnames[15] # y column
print(target)
